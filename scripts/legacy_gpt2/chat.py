...
def load_config():
    ...
    if not config_path.exists():
        ...
        return {
            ...
            "default_checkpoint": "checkpoints/legacy_gpt2/out-clutch-gpt2-alpacagpt4",
        }
...
def main():
    ...
    if args.ckpt:
        ...
        ckpt_path = REPO_ROOT / "checkpoints" / "legacy_gpt2" / "out-clutch-0.1" / "ckpt.pt"
    else:
        ckpt_path = REPO_ROOT / "checkpoints" / "legacy_gpt2" / "out-clutch-gpt2-alpacagpt4" / "ckpt.pt"
